...
$config['licenseName'] = 'htdev.xyz';
$config['licenseKey']  = 'Q8XA-Q1QQ-JQQ7-QJQQ-QLQQ-GQKQ-3QQH';
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'files',
    'maxSize'           => 0,
    'allowedExtensions' => 'svg,7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'images',
    'maxSize'           => 0,
    'allowedExtensions' => 'svg,bmp,gif,jpeg,jpg,png',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
