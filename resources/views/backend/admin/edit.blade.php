                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" name="password"
                                            placeholder="Enter Password" value="{{ $admin->password }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="email"
                                            placeholder="Enter Name" value="{{ $admin->email }}">
                                    </div>

                                    <div class="form-group">
                                        <label>Image</label>
                                        <div class="input-group input-group-sm">
                                            <input type="text" class="form-control" id="image" name="image" value="{{ $admin->image }}">
                                    ...
                                    <div class="form-group">
                                        <img id="Thumbnail" src="{{ $admin->image }}" style="width: 100px">
                                    </div>

                                    <div class="form-group">
                                        <label>Group</label>
                                        <select class="form-control select2" style="width: 100%;" name="group" >
                                                <option @if ($admin->group == 1) selected @endif value="1">Admin</option>
                                                <option @if ($admin->group == 2) selected @endif value="2">Biên tập</option>
                                                <option @if ($admin->group == 3) selected @endif value="3">Tư vấn điện thoại</option>
                                        </select>
                                    </div>
