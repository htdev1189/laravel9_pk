                            ...
                            <form method="post" action="/admin/posts/save">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group" id="description-out">
                                        ...
                                        <textarea class="form-control" name="description" id="description" rows="10" placeholder="Enter description here">{{ old('description') }}</textarea>
                                    </div>
                                    ...
                                    <div class="form-group" id="content-out">
                                        <label>Content</label>
                                        <textarea class="form-control" name="content" id="content" rows="20" placeholder="Enter content here">{{ old('content') }}</textarea>
                                    </div>
